...
%inclusion line
%grating
% epi{1}(125:150,120:125)= c_eps_0*11.3;
% epi{1}(125:150,110:115)= c_eps_0*11.3;
% epi{1}(125:150,100:105)= c_eps_0*11.3;
% epi{1}(125:150,90:95)= c_eps_0*11.3;
% epi{1}(125:150,80:85)= c_eps_0*11.3;
% epi{1}(125:150,70:75)= c_eps_0*11.3;
% epi{1}(125:150,60:65)= c_eps_0*11.3;
% epi{1}(125:150,50:55)= c_eps_0*11.3;
% epi{1}(125:150,40:45)= c_eps_0*11.3;


epi{1}(130:160,115:130)= c_eps_0*11.3;
epi{1}(20:170,20:30)= c_eps_0*11.3;
epi{1}(145:160,30:60)= c_eps_0*11.3;
epi{1}(30:45,30:60)= c_eps_0*11.3;
epi{1}(100:170,83:85)= c_eps_0*11.3;
